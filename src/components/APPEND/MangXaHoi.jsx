...
export default function MangXaHoi() {
    ...
    const bground = {
        cursor: 'auto',
        backgroundImage: 'url("/pics/mangxahoi.jpg")',
    }
    return (
        <div className="container_gioithieu" id="aboutus" onClick={disappend} style={{ cursor: 'pointer' }}>
            {append && <div className="inside_gioithieu" onClick={(event) => event.stopPropagation()} style={bground} >
                <h1>Mạng xã hội <i className="fa-solid fa-circle-xmark" style={{ float: 'right', marginTop: "100px", color: 'red', cursor: 'pointer' }} onClick={disappend}></i></h1>
