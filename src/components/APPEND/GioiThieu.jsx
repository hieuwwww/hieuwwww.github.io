...
export default function GioiThieu() {
    ...
    function disappend() {
        const myDiv = document.getElementById('social');
    ...
    return (
        <div className="container_gioithieu" id="social" onClick={disappend} style={{ cursor: 'pointer' }}>
            {append && <div className="inside_gioithieu" onClick={(event) => event.stopPropagation()} style={{ cursor: 'auto' }}>
                <h1>Giới thiệu  <i className="fa-solid fa-circle-xmark" style={{ float: 'right', marginTop: "100px", color: 'red', cursor: 'pointer' }} onClick={disappend}></i></h1>
