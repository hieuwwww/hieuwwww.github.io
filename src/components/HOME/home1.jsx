...
function Home1() {
    ...
    return (
        <div className="container_home1">
            ...
            <span className="item_home1" style={{ marginTop: '20px', }}><a href="/MathHome" style={{ padding: '15px 30px', borderRadius: '35px', fontSize: '25px', background: 'linear-gradient(48deg,#03AED2,rgb(167, 197, 252))' }}>Bắt đầu học ngay</a></span>
        </div>
    );
}
